...
def calendar(request, year, month, series_id=None):
    ...
    my_reading_events = Reading.objects.filter(date_and_time__gte=my_calendar_from_month).filter(
    ...
    return render_to_response("calendario_display.html", {'readings_list': my_reading_events,
                                                    'month': my_month,
